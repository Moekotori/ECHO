...
export function createEqApi(
  ...
  return {
    ...
    getDspRackState: () => ipcRenderer.invoke(IpcChannels.EqGetDspRackState),
    setDspRackState: (state) => ipcRenderer.invoke(IpcChannels.EqSetDspRackState, state),
    getCompressorState: () => ipcRenderer.invoke(IpcChannels.EqGetCompressorState),
    setCompressorState: (state) => ipcRenderer.invoke(IpcChannels.EqSetCompressorState, state),
    getCrossfeedState: () => ipcRenderer.invoke(IpcChannels.EqGetCrossfeedState),
    setCrossfeedState: (state) => ipcRenderer.invoke(IpcChannels.EqSetCrossfeedState, state),
    getStereoFieldState: () => ipcRenderer.invoke(IpcChannels.EqGetStereoFieldState),
    setStereoFieldState: (state) => ipcRenderer.invoke(IpcChannels.EqSetStereoFieldState, state),
    getChannelMatrixState: () => ipcRenderer.invoke(IpcChannels.EqGetChannelMatrixState),
    setChannelMatrixState: (state) => ipcRenderer.invoke(IpcChannels.EqSetChannelMatrixState, state),
