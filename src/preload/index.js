...
contextBridge.exposeInMainWorld("api", {
  ...
  openFileHandler: (locale) =>
    ipcRenderer.invoke("dialog:openFile", { locale }),
  openImageHandler: (locale) =>
    ipcRenderer.invoke("dialog:openImage", { locale }),
  openThemeJsonHandler: (locale) =>
    ipcRenderer.invoke("dialog:openThemeJson", { locale }),
  saveThemeJsonHandler: (text, defaultName, locale) =>
    ipcRenderer.invoke("dialog:saveThemeJson", text, defaultName, {
      locale,
    }),
  openLyricsFileHandler: (locale) =>
    ipcRenderer.invoke("dialog:openLyricsFile", { locale }),
  openFontFileHandler: (locale) =>
    ipcRenderer.invoke("dialog:openFontFile", { locale }),
