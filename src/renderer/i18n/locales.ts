...
export type TranslationKey =
  ...
  | 'audioProfessional.row.uzumeReferenceArtifactManifest'
...
const zhCN: TranslationMap = {
  ...
  'audioDrawer.badge.dspActive': 'UZUME skeleton',
  ...
  'audioDrawer.note.asioNativeDsd': '默认关闭。仅 ASIO + 本地 DSF + DoP 开启且无 EQ/音量/变速/UZUME section 时尝试；失败会退回现有 DoP/PCM。',
  ...
  'audioDrawer.signal.balanceDsp': 'UZUME Balance',
  'audioDrawer.signal.bitPerfect': 'Bit-perfect',
  'audioDrawer.signal.dspOn': 'UZUME On',
  ...
  'audioProfessional.issue.audioLevelClipped': '实时电平检测到削波，请降低前级增益或关闭增益类 UZUME section。',
  'audioProfessional.issue.audioLevelClippingRisk': '实时电平接近 0 dBFS，有削波风险。',
  'audioProfessional.issue.dspClippingRisk': 'UZUME 链路输出有削波风险，Protect limiter 已进入待命监控。',
  'audioProfessional.issue.dspLimiterProtecting': 'Protect limiter 正在保护输出，说明 UZUME 后级信号已经超过安全阈值。',
  ...
  'audioProfessional.group.directDsp': '直通与 UZUME',
  ...
  'audioProfessional.signal.dsp': 'UZUME',
  ...
  'audioProfessional.row.uzumeReferenceArtifactManifest': 'UZUME artifact manifest reference',
  ...
  'audioProfessional.row.uzumeReferenceRenderAheadCache': 'UZUME render-ahead cache reference',
  'audioProfessional.row.uzumeReferenceReadinessContract': 'UZUME readiness contract reference',
  'audioProfessional.row.uzumeReferenceRealtimeBudgetSummary': 'UZUME realtime budget summary reference',
  ...
  'audioProfessional.value.dspPath': 'UZUME 路径：{modules}',
  ...
  'route.dsp.description': 'UZUME 信号引擎工作台。',
  'route.dsp.label': 'UZUME',
  ...
  'settings.eq.bitPerfect.channelDisabled': 'UZUME 已启用：bit-perfect 已关闭。',
  'settings.eq.bitPerfect.disabled': 'UZUME 已启用：bit-perfect 已关闭{reason}。',
  ...
  'settings.eq.comfort.directDetail': 'UZUME section 关闭时不压低音量、不改动采样，适合放心听原声。',
  ...
  'settings.eq.comfort.tunedDetail': '只处理已开启的 UZUME section；关闭后会回到原生播放路径。',
  ...
  'settings.eq.level.sourceEstimate': 'pre-native + UZUME 估算',
  ...
  'settings.eq.signal.dspActive': 'UZUME 信号链已启用',
  'settings.eq.signal.dspOutput': 'UZUME 输出',
  ...
  'settings.eq.routing.dspPath': 'UZUME 路径',
  'settings.eq.routing.dspPathDetail': '当前处理会明确显示在链路中。',
  'settings.eq.routing.headroomActiveDetail': '余量正在 UZUME 路径中生效。',
  'settings.eq.routing.headroomStandby': '余量已接入',
  'settings.eq.routing.headroomStandbyDetail': '余量本身会进入 PCM processed skeleton，bit-perfect / DSD direct 会退出。',
  ...
  'settings.eq.routing.nativeBypassComfort': 'UZUME 旁路时会保持原生直通，样本不会被效果链改动。',
  'settings.eq.routing.nativeDirect': '原生直通',
  'settings.eq.routing.nativeDirectDetail': 'UZUME 旁路时不会改动原生播放。',
  ...
  'settings.eq.headroom.dsp': 'UZUME 余量',
  'settings.eq.headroom.nativeBypassNote': '非 0 dB 余量会直接进入 PCM processed skeleton，并退出 bit-perfect / DSD direct / DSD upsampling。',
  'settings.eq.headroom.presetsAria': 'UZUME 余量快捷档位',  'settings.eq.profile.bound': '{output} 已绑定 {profile}',
  ...
  'settings.playback.asioNativeDsd.description': '默认关闭。仅在 ASIO + 本地 DSF + DoP 开启且无 EQ/音量/变速/UZUME section 时尝试；失败会退回现有 DoP/PCM。',
...
const zhTW: TranslationMap = {
  ...
  'audioDrawer.badge.dspActive': 'UZUME 啟用',
  ...
  'audioDrawer.note.asioNativeDsd': '預設關閉。僅 ASIO + 本機 DSF + DoP 開啟且無 EQ/音量/變速/UZUME section 時嘗試；失敗會退回現有 DoP/PCM。',
  ...
  'audioDrawer.signal.balanceDsp': 'UZUME 平衡',
  'audioDrawer.signal.bitPerfect': 'Bit-perfect',
  'audioDrawer.signal.dspOn': 'UZUME 開啟',
  ...
  'audioProfessional.issue.audioLevelClipped': '即時電平偵測到削波，請降低前級增益或關閉增益類 UZUME section。',
  'audioProfessional.issue.audioLevelClippingRisk': '即時電平接近 0 dBFS，有削波風險。',
  'audioProfessional.issue.dspClippingRisk': 'UZUME 鏈路輸出有削波風險，Protect limiter 已進入待命監控。',
  'audioProfessional.issue.dspLimiterProtecting': 'Protect limiter 正在保護輸出，表示 UZUME 後級訊號已超過安全閾值。',
  ...
  'audioProfessional.group.directDsp': '直通與 UZUME',
  ...
  'audioProfessional.value.dspPath': 'UZUME 路徑：{modules}',
  ...
  'route.dsp.description': 'UZUME 訊號引擎工作台。',
  'route.dsp.label': 'UZUME',
  'connectPage.controls.aria': 'Connect 控制',
  ...
  'settings.eq.bitPerfect.channelDisabled': 'UZUME 已啟用：bit-perfect 已關閉。',
  'settings.eq.bitPerfect.disabled': 'UZUME 已啟用：bit-perfect 已關閉{reason}。',
  ...
  'settings.eq.comfort.directDetail': 'UZUME section 關閉時不壓低音量、不改動取樣，適合放心聽原聲。',
  ...
  'settings.eq.comfort.tunedDetail': '只處理已啟用的 UZUME section；關閉後會回到原生播放路徑。',
  ...
  'settings.eq.signal.dspActive': 'UZUME 訊號鏈已啟用',
  'settings.eq.signal.dspOutput': 'UZUME 輸出',
  ...
  'settings.eq.routing.action.nativeDirect': '原生直通',
  'settings.eq.routing.armed': '已待命',
  'settings.eq.routing.dspPath': 'UZUME 路徑',
  'settings.eq.routing.dspPathDetail': '目前處理會明確顯示在鏈路中。',
  'settings.eq.routing.headroomActiveDetail': '餘量正在 UZUME 路徑中生效。',
  'settings.eq.routing.headroomStandby': '餘量已接入',
  'settings.eq.routing.headroomStandbyDetail': '餘量本身會進入 PCM processed skeleton，bit-perfect / DSD direct 會退出。',
  ...
  'settings.eq.routing.nativeBypassComfort': 'UZUME 旁路時會保持原生直通，樣本不會被效果鏈改動。',
  'settings.eq.routing.nativeDirect': '原生直通',
  'settings.eq.routing.nativeDirectDetail': 'UZUME 旁路時不會改動原生播放。',
  ...
  'settings.eq.routing.safety': '安全',
  'settings.eq.headroom.dsp': 'UZUME 餘量',
  'settings.eq.headroom.nativeBypassNote': '非 0 dB 餘量會直接進入 PCM processed skeleton，並退出 bit-perfect / DSD direct / DSD upsampling。',
  'settings.eq.headroom.presetsAria': 'UZUME 餘量快捷檔位',  'settings.eq.mode.aria': 'EQ 顯示模式',
  'settings.eq.mode.current': '模式',
  'settings.eq.mode.pro': 'Pro',
  'settings.eq.mode.simple': 'Simple',
  ...
  'settings.playback.asioNativeDsd.description': '預設關閉。僅在 ASIO + 本地 DSF + DoP 開啟且沒有 EQ/音量/變速/UZUME section 時嘗試；失敗會退回現有 DoP/PCM。',
...
const jaJP: TranslationMap = {
  ...
  'audioDrawer.badge.dspActive': 'UZUME 有効',
  ...
  'audioDrawer.note.asioNativeDsd': '既定ではオフです。ASIO + ローカル DSF + DoP 有効、かつ EQ/音量/速度/UZUME section なしの時だけ試し、失敗時は既存の DoP/PCM に戻します。',
  ...
  'audioDrawer.signal.balanceDsp': 'UZUME バランス',
  'audioDrawer.signal.bitPerfect': 'Bit-perfect',
  'audioDrawer.signal.dspOn': 'UZUME オン',
  ...
  'audioProfessional.issue.audioLevelClipped': 'リアルタイムレベルでクリップを検出しました。プリアンプを下げるか、ゲイン系 UZUME section をオフにしてください。',
  'audioProfessional.issue.audioLevelClippingRisk': 'リアルタイムレベルが 0 dBFS に近く、クリップの危険があります。',
  'audioProfessional.issue.dspClippingRisk': 'UZUME チェーン出力にクリップの危険があります。Protect limiter は待機監視中です。',
  'audioProfessional.issue.dspLimiterProtecting': 'Protect limiter が出力を保護しています。UZUME 後段の信号が安全しきい値を超えています。',
  ...
  'audioProfessional.group.directDsp': 'Direct / UZUME',
  ...
  'audioProfessional.value.dspPath': 'UZUME Path: {modules}',
  ...
  'route.dsp.description': 'UZUME 信号エンジンワークベンチ。',
  'route.dsp.label': 'UZUME',
  ...
  'settings.eq.bitPerfect.channelDisabled': 'UZUME 有効: bit-perfect は無効です。',
  'settings.eq.bitPerfect.disabled': 'UZUME 有効: bit-perfect は無効です{reason}。',
  ...
  'settings.eq.comfort.directDetail': 'UZUME section オフ時は音量を下げず、サンプルも変更しません。原音を安心して聴けます。',
  ...
  'settings.eq.comfort.tunedDetail': '有効な UZUME section だけを処理します。オフにするとネイティブ再生経路へ戻ります。',
  ...
  'settings.eq.level.sourceEstimate': 'pre-native + UZUME 推定',
  ...
  'settings.eq.signal.dspActive': 'UZUME 信号チェーン有効',
  'settings.eq.signal.dspOutput': 'UZUME 出力',
  ...
  'settings.eq.routing.dspPath': 'UZUME パス',
  'settings.eq.routing.dspPathDetail': '有効な処理は信号経路に明示されます。',
  'settings.eq.routing.headroomActiveDetail': 'ヘッドルームは UZUME パスで有効です。',
  'settings.eq.routing.headroomStandby': 'ヘッドルーム接続済み',
  'settings.eq.routing.headroomStandbyDetail': 'ヘッドルーム自体が PCM processed skeleton に入り、bit-perfect / DSD direct は終了します。',
  ...
  'settings.eq.routing.nativeBypassComfort': 'UZUME バイパス時はネイティブ直通を保ち、サンプルはエフェクトチェーンで変更されません。',
  'settings.eq.routing.nativeDirect': 'ネイティブ直通',
  'settings.eq.routing.nativeDirectDetail': 'UZUME バイパス時はネイティブ再生を変更しません。',
  ...
  'settings.eq.routing.safety': '安全',
  'settings.eq.headroom.dsp': 'UZUME ヘッドルーム',
  'settings.eq.headroom.nativeBypassNote': '0 dB 以外のヘッドルームは PCM processed skeleton に入り、bit-perfect / DSD direct / DSD upsampling を終了します。',
  'settings.eq.headroom.presetsAria': 'UZUME ヘッドルームのプリセット',  'settings.eq.mode.aria': 'EQ 表示モード',
  ...
  'settings.playback.asioNativeDsd.description': '既定ではオフです。ASIO + ローカル DSF + DoP が有効で、EQ/音量/変速/UZUME section がない場合のみ試行します。失敗時は既存の DoP/PCM に戻ります。',
...
const enUS: TranslationMap = {
  ...
  'audioDrawer.note.asioNativeDsd': 'Off by default. Tries only for ASIO + local DSF + DoP with no EQ, volume, speed, or UZUME sections; falls back to the existing DoP/PCM path on failure.',
  ...
  'audioProfessional.issue.audioLevelClipped': 'Real-time level metering detected clipping. Lower preamp gain or disable gain-boosting UZUME sections.',
  'audioProfessional.issue.audioLevelClippingRisk': 'Real-time level is near 0 dBFS and may clip.',
  'audioProfessional.issue.dspClippingRisk': 'Transitional DSP output has clipping risk. Protect limiter is armed and monitoring.',
  'audioProfessional.issue.dspLimiterProtecting': 'Protect limiter is actively protecting the output because post-UZUME signal exceeded the safe threshold.',
  ...
  'route.dsp.description': 'UZUME signal engine workbench.',
  'route.dsp.label': 'UZUME',
  'connectPage.controls.aria': 'Connect controls',
  ...
  'settings.eq.bitPerfect.channelDisabled': 'DSP path active: bit-perfect disabled.',
  'settings.eq.bitPerfect.disabled': 'DSP path active: bit-perfect disabled{reason}.',
  ...
  'settings.eq.level.sourceEstimate': 'pre-native + UZUME estimate',
  ...
  'settings.eq.signal.dspActive': 'UZUME signal path active',
  'settings.eq.signal.dspOutput': 'UZUME output',
  ...
  'settings.eq.comfort.directDetail': 'When UZUME sections are off, volume is not reduced and samples are not changed. Good for hearing the original path.',
  ...
  'settings.eq.comfort.tunedDetail': 'Only enabled UZUME sections are processed. Turn them off to return to the native playback path.',
  ...
  'settings.eq.routing.dspPath': 'UZUME Path',
  'settings.eq.routing.dspPathDetail': 'Processing is explicit and visible.',
  'settings.eq.routing.headroomActiveDetail': 'Headroom is active in the UZUME path.',
  'settings.eq.routing.headroomStandby': 'Headroom Routed',
  'settings.eq.routing.headroomStandbyDetail': 'Headroom itself enters PCM processed skeleton and exits bit-perfect / DSD direct.',
  ...
  'settings.eq.routing.nativeBypassComfort': 'UZUME bypass keeps playback native-direct, and samples are not changed by the effect chain.',
  'settings.eq.routing.nativeDirect': 'Native Direct',
  'settings.eq.routing.nativeDirectDetail': 'UZUME bypass keeps playback untouched.',
  ...
  'settings.eq.headroom.dsp': 'UZUME Headroom',
  'settings.eq.headroom.nativeBypassNote': 'Non-zero headroom enters PCM processed skeleton and exits bit-perfect / DSD direct / DSD upsampling.',
  'settings.eq.headroom.presetsAria': 'UZUME Headroom presets',  'settings.eq.profile.bound': '{output} bound to {profile}',
  ...
  'settings.playback.asioNativeDsd.description': 'Off by default. Only tries ASIO + local DSF + DoP when EQ, volume, speed, and UZUME sections are inactive; failures fall back to the existing DoP/PCM path.',
