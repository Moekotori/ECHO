...
const zhCN: TranslationMap = {
  ...
  'audioDrawer.badge.dspActive': 'UZUME active',
  ...
  'settings.eq.routing.headroomStandbyDetail': '余量本身会进入 UZUME processed，bit-perfect / DSD direct 会退出。',
  ...
  'settings.eq.headroom.nativeBypassNote': '非 0 dB 余量会直接进入 UZUME processed，并退出 bit-perfect / DSD direct / DSD upsampling。',
...
const zhTW: TranslationMap = {
  ...
  'settings.eq.routing.headroomStandbyDetail': '餘量本身會進入 UZUME processed，bit-perfect / DSD direct 會退出。',
  ...
  'settings.eq.headroom.nativeBypassNote': '非 0 dB 餘量會直接進入 UZUME processed，並退出 bit-perfect / DSD direct / DSD upsampling。',
...
const jaJP: TranslationMap = {
  ...
  'settings.eq.routing.headroomStandbyDetail': 'ヘッドルーム自体が UZUME processed に入り、bit-perfect / DSD direct は終了します。',
  ...
  'settings.eq.headroom.nativeBypassNote': '0 dB 以外のヘッドルームは UZUME processed に入り、bit-perfect / DSD direct / DSD upsampling を終了します。',
...
const enUS: TranslationMap = {
  ...
  'audioProfessional.issue.dspClippingRisk': 'UZUME chain output has clipping risk. Protect limiter is armed and monitoring.',
  ...
  'settings.eq.bitPerfect.channelDisabled': 'UZUME active: bit-perfect disabled.',
  'settings.eq.bitPerfect.disabled': 'UZUME active: bit-perfect disabled{reason}.',
  ...
  'settings.eq.routing.headroomStandbyDetail': 'Headroom itself enters UZUME processed and exits bit-perfect / DSD direct.',
  ...
  'settings.eq.headroom.nativeBypassNote': 'Non-zero headroom enters UZUME processed and exits bit-perfect / DSD direct / DSD upsampling.',
