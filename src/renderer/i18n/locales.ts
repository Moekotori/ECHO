...
const zhCN: TranslationMap = {
  ...
  'settings.eq.routing.headroomStandbyDetail': '仅在启用 UZUME section 后生效。',
...
const zhTW: TranslationMap = {
  ...
  'settings.eq.routing.headroomStandbyDetail': '只會在啟用 UZUME section 後生效。',
...
const jaJP: TranslationMap = {
  ...
  'settings.eq.routing.headroomStandbyDetail': 'UZUME section を有効にした時だけ適用されます。',
...
const enUS: TranslationMap = {
  ...
  'settings.eq.routing.headroomStandbyDetail': 'Will apply only when a UZUME section is enabled.',
