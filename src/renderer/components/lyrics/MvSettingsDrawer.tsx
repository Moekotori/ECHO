          ...
          {isNetworkSectionOpen ? (
            <>
              ...
              <button
                ...
                aria-pressed={settings.titleOnlySearch !== false}
                onClick={() => void patchSettings({ titleOnlySearch: settings.titleOnlySearch === false })}
              >
                <span className="mv-switch-track" aria-hidden="true">
                  <span />
                </span>
                <span className="mv-toggle-copy">
                  <strong>{t('mvSettings.network.titleOnlySearch')}</strong>
                  <em>{t('mvSettings.network.titleOnlySearchDescription')}</em>
                </span>
              </button>
              ...
              <button
                type="button"
                className="mv-source-toggle mv-auto-apply-toggle"
                aria-pressed={settings.preferHighestViewCount !== false}
                onClick={() => void patchSettings({ preferHighestViewCount: !(settings.preferHighestViewCount !== false) })}
              >
                <span className="mv-switch-track" aria-hidden="true">
                  <span />
                </span>
