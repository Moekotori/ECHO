  ...
  return (
    <section className="settings-cache-panel settings-library-lab-panel" aria-labelledby="library-lab-title" data-expanded={isExpanded}>
      ...
      <div className="settings-library-lab-status" aria-label="Library Lab status">
        ...
        <div className="settings-library-lab-status-item">
          <span>nativeFileScanner.protocolVersion</span>
          <strong>{labState.nativeFileScanner.protocolVersion ?? '-'}</strong>
        </div>
        <div className="settings-library-lab-status-item">
          <span>nativeFileScanner.workerFeatures</span>
          <strong>{labState.nativeFileScanner.workerFeatures?.join(', ') ?? '-'}</strong>
        </div>
        <div className="settings-library-lab-status-item">
        ...
        <div className="settings-library-lab-status-item">
          <span>nativeMetadataReader.protocolVersion</span>
          <strong>{labState.nativeMetadataReader.protocolVersion ?? '-'}</strong>
        </div>
        <div className="settings-library-lab-status-item">
          <span>nativeMetadataReader.workerFeatures</span>
        ...
        <div className="settings-library-lab-status-item">
          <span>nativeMetadataReader.supportedExtensions</span>
          <strong>{labState.nativeMetadataReader.supportedExtensions?.join(', ') ?? '-'}</strong>
        </div>
        <div className="settings-library-lab-status-item">
