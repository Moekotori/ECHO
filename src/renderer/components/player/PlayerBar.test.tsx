  ...
  it('shows UZUME reference compiler assignments in the signal path popover', () => {
    ...
    expect(visualState.nodes).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({ title: 'UZUME gain staging reference', tone: 'process', variant: 'process' }),
        expect.objectContaining({ title: 'UZUME PEQ/IIR reference', tone: 'process', variant: 'process' }),
        expect.objectContaining({ title: 'UZUME channel scope reference', tone: 'process', variant: 'process' }),
        expect.objectContaining({ title: 'UZUME stereo procedural reference', tone: 'process', variant: 'process' }),
        expect.objectContaining({ title: 'UZUME per-ear EQ placement reference', tone: 'process', variant: 'process' }),
        ...
        expect.objectContaining({ title: 'UZUME gapless SRC reference', tone: 'process', variant: 'process' }),
        expect.objectContaining({ title: 'UZUME FIR gapless reference', tone: 'process', variant: 'process' }),
        expect.objectContaining({ title: 'UZUME urgent controls reference', tone: 'process', variant: 'process' }),
        expect.objectContaining({ title: 'UZUME equal-power crossfade reference', tone: 'process', variant: 'process' }),
