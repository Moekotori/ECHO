...
const normalizeSettingsPatch = (patch: Partial<MvSettings>): Partial<MvSettings> => {
  ...
  if (typeof patch.titleOnlySearch === 'boolean') {
    normalized.titleOnlySearch = patch.titleOnlySearch;
  }
  ...
  if (typeof patch.immersiveBackgroundScalePercent === 'number' && Number.isFinite(patch.immersiveBackgroundScalePercent)) {
    normalized.immersiveBackgroundScalePercent = normalizePercent(patch.immersiveBackgroundScalePercent, 115, 70, 220);
  }
...
const appSettingsToMvSettings = (): MvSettings => {
  ...
  return {
    ...
    immersiveBackgroundScalePercent: normalizePercent(settings.mvImmersiveBackgroundScalePercent, 115, 70, 220),
...
export class MvService {
  ...
  setSettings(patch: Partial<MvSettings>): MvSettings {
    ...
    if (typeof normalized.titleOnlySearch === 'boolean') {
      appSettingsPatch.mvTitleOnlySearch = normalized.titleOnlySearch;
    }
