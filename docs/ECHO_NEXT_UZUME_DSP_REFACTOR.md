...
- RPC-001/RPC-002 相关 renderer/main vitest 6 个文件、505 个测试通过，覆盖 DSP 页 `未实现` UI、Signal Path skeleton/reference 文案、Professional Status、AudioSettingsDrawer、EQ panel 和 `uzumeFormatPathPlan` / `uzumeReferencePlan` telemetry。
